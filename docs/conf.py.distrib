...
try:
    import faker_file_qt

    version = faker_file_qt.__version__
    project = faker_file_qt.__title__
    copyright = faker_file_qt.__copyright__
except ImportError:
    version = "0.1"
    project = "faker-file-qt"
